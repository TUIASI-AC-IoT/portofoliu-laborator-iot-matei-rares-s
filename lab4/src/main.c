...
void app_main(void)
{
    ...
    if (connected) {
        ...
        start_mdns_service();
        xTaskCreate(&discover_mdns_hosts, "mdns_discovery_task", 4096, NULL, 5, NULL);
        xTaskCreate(&find_services, "find_services", 4096, NULL, 5, NULL);
