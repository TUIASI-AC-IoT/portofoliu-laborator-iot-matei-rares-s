...
//TODO: daca valoare din versioning e diferita de nr de build din include/version.h, modificati valoarea de mai jos
//TODO: Modificati adresa IP de mai jos pentru a coincide cu cea a PC-ul pe care rulati scriptul python
#define CONFIG_EXAMPLE_FIRMWARE_UPGRADE_URL "https://192.168.89.16:5000/firmware.bin" 
#define VERSION_URL "https://192.168.89.16:5000/version" 
...
static void ota_task(void *pvParameters)
{
    ...
    int server_version = fetch_version();
    if (server_version != 46) {
        ESP_LOGI(TAG, "Version check failed. Expected 46, got %d. Aborting update.", server_version);
        vTaskDelete(NULL);
        return;
    }
